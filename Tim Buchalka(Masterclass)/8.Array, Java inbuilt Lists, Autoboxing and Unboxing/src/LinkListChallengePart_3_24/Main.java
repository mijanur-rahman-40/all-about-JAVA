package LinkListChallengePart_3_24;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Love does't mean a thing", 4.22);
                ...
                case 3:
                    if(forward) {
                        ...
                        if(listIterator.hasNext()) {
                            ...
                            System.out.println("We are reached the end of the list");
                        }
                    }
                    break;
                case 4:
